<div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="pull-left">Overdue Tax Invoices</h3>
          </div>
        </div><!-- /.row -->
				...
				?>
                  <table class="table table-bordered table-striped tablesorter">
					...
					if( isset($overdue_invoices) && !empty($overdue_invoices))
					{
						...
						<a href="javascript:;" onclick="viewTaxInvoice('<?php echo $invoice['invoice_id']; ?>')" class="btn btn-info btn-xs"><i class="fa fa-search"> Preview </i></a>
