...
<div class="row">
 ...
 <div id="page-wrapper">
		...
		?>
					<div class="row">
						<div class="col-lg-6">
						<h3> Tax Invoice Number : # <?php echo $invoice_details->invoice_number; ?> </h3>
			...
			<div class="table-responsive">			
              <table id="item_table" class="table table-bordered">
                ...
                <tbody>
					...
					<td style="width:12%">
					<select name="tax_rate_id" id="tax_rate_id" class="form-control"><?php echo $taxrates; ?></select>
					</td>
					<td style="width:5%"><input class="form-control" onchange="javascript: calculateTaxInvoiceAmounts();"  name="item_quantity" value=""/></td>
					<td class="text-right" style="width:10%"><input class="form-control text-right" onchange="javascript: calculateTaxInvoiceAmounts();"  name="item_price" value=""/></td>
					<td class="text-right" style="width:8%"><input class="form-control text-right" onchange="javascript: calculateTaxInvoiceAmounts();"  name="item_discount" value=""/></td>
				  ...
				  <?php 
					...
					?>
						...
						<td style="width:12%">
							<select name="tax_rate_id" id="tax_rate_id" onchange="javascript: calculateTaxInvoiceAmounts();" class="form-control" ><?php echo get_tax_select($item['item_taxrate_id']); ?></select>
						</td>
						<td style="width:10%"><input class="form-control" onchange="javascript: calculateTaxInvoiceAmounts();"  name="item_quantity" value="<?php echo $item['item_quantity']; ?>"/></td>
						<td class="text-right" style="width:10%"><input class="form-control text-right" onchange="javascript: calculateTaxInvoiceAmounts();"  name="item_price" value="<?php echo $item['item_price']; ?>"/></td>
						
						<td class="text-right" style="width:8%"><input class="form-control text-right" onchange="javascript: calculateTaxInvoiceAmounts();"  name="item_discount" value="<?php echo $item['item_discount']; ?>"/></td>
						<td class="text-right" style="width:10%"><input class="form-control text-right" onchange="javascript: calculateTaxInvoiceAmounts();"  name="item_sub_total" readonly value="<?php echo $item['item_total']; ?>"/></td>
						
						<td style="width:2%">
						<a class="" href="<?php echo site_url('tax_invoices/delete_item/'.$item['invoice_id'].'/'.$item['item_id']);?>" title="delete"><i class="fa fa-times"></i></a>
						</td>
						</tr>
					<?php
						}
				...
				<table class="table table-bordered">
				 ...
				 <tr class="text-right">
					...
					<div class="form-group input-group invoice_grand_total" style="margin-bottom: 0px">
						...
						<input type="text" class="form-control text-right invoice_grand_total" name="invoice_discount_amount" onchange="javascript: calculateTaxInvoiceAmounts();"  id="invoice_discount_amount" value="<?php echo number_format($invoice_details->invoice_discount, 2); ?>"/>
					 </div>
					</td>
					<td style="width:2%"></td>
                  </tr>
                  ...
                  <tr class="text-right">
                    <td colspan="6" class="no-border"> Total before @ 6% : </td>
				  ...
				  <tr class="text-right">
                    <td colspan="6" class="no-border"> Add GST @ 6% :</td>
                    <td ><label><span id="invoice_total_tax"><?php echo format_amount($invoice_details->invoice_totals['tax_total']); ?></span></label></td>
					<td style="width:2%"></td>
                  </tr>

				  <tr class="text-right">
                    <td colspan="6" class="no-border"> Total Sales : </td>
                    <td class="invoice_amount_due"><label><span id="invoice_sub_total2"><?php echo format_amount( $invoice_details->invoice_totals['item_total'] - $invoice_details->invoice_discount + $invoice_details->invoice_totals['tax_total']); ?></span></label></td>
					<td style="width:2%"></td>
                  </tr>
