...
<div class="row">
	<div class="col-lg-12">
		<div class="well invoice_menu navbar navbar-fixed-top">
			...
			<a href="javascript: void(0);" onclick="javascript: ajax_save_tax_invoice();" class="btn btn-large btn-success pull-right" id="bttn_save_invoice"><i class="fa fa-check"></i> Save Tax Invoice</a>
		</div>
	</div>
</div>
              ...
              <table id="item_table" class="table table-bordered">
                ...
                <tbody>
                  <tr id="new_item" style="display: none;">
                    ...
                    <td style="width:10%">
					<select name="tax_rate_id" id="tax_rate_id" onchange="javascript: calculateTaxInvoiceAmounts();" class="form-control" ><?php echo $taxrates; ?></select>
					</td>
					...
					<td class="text-right" style="width:10%"><input class="form-control text-right" onchange="javascript: calculateTaxInvoiceAmounts();"  name="item_discount" value=""/></td>
				 ...
				 <tr class="text-right">
					...
					<div class="form-group input-group invoice_grand_total" style="margin-bottom: 0px">
						...
						<input type="text" class="form-control text-right invoice_grand_total" name="invoice_discount_amount" onchange="javascript: calculateTaxInvoiceAmounts();"  id="invoice_discount_amount" value="0.00"/>
					 </div>
					</td>
                  </tr>
