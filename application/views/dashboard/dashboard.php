...
<!--hr/-->
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-money"></i> Recent Tax Invoices</h3>
              </div>
              <div class="panel-body">
                <div class="table-responsive">
                   <table class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php
					if( isset($recent_tax_invoices))
					{
						foreach ($recent_tax_invoices as $count => $invoice)
						{
						?>
						<tr>
						<!--td>
            ...
            <td class="text-right"><?php echo format_amount($invoice['invoice_amount']); ?></td>
                ...
                <div class="text-right">
                  <a href="<?php echo site_url('tax_invoices');?>">View All Tax Invoices <i class="fa fa-arrow-circle-right"></i></a>
                </div>
              </div>
            </div>
          </div>
